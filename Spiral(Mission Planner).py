...
for i in range(1,150) :
    point.append(get_location_metres(vehicle.location.global_frame, (aSize + (rate_of_radius * i)) * (math.sin(omega * i)), (aSize + (rate_of_radius * i)) * (math.cos(omega * i))))
...
for i in point :
    vehicle.simple_goto(i,groundspeed=50)
    time.sleep(2)
