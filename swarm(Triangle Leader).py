...
vehicle2.simple_goto(get_location_metres(vehicle1.location.global_frame, 0, -40, 10), groundspeed=20)
time.sleep(15)
arm_and_takeoff(10, vehicle1)
vehicle1.simple_goto(pt1, groundspeed=10)
for i in range(8) :
    p = get_location_metres(vehicle1.location.global_relative_frame, 0, -40, 10)
